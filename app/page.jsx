  ...
  return (
    <div className="container flex flex-col md:flex-row gap-5 h-[calc(100vh-4rem)]">
      <div className="basis-full flex flex-col mt-40 md:basis-3/2">
        <p className="special-word mb-4 text-xs"> Pakistan has the world's most beautiful </p>
        <h1 className="pb-5">
        Places  <span className="special-word"> in</span><br /> Pakistan
        </h1>
      ...
      <div className="hidden mt-20  md:block basis-3/4">
        <Image 
          src={dem1}
          alt="beautiful"
          sizes="100vw"
